...
def list_songs(request):
    ...
    return render(request, 'cw_app/songs.html', context)


def details_songs(request, song_id):
    return render(request, 'cw_app/songs_details.html', {'current_song': songs[song_id]})
